          ...
          <div className="row">
            <div className="col-md-9 col-sm-9 col-xs-12">
              ...
              <div className="property_single_details_price">
                ...
                <ul>
                  <li>
                    <i className="fa fa-check"></i> 4 bed rooms
                  </li>
                  <li>
                    <i className="fa fa-check"></i> 1 garage
                  </li>
                  <li>
                    <i className="fa fa-check"></i> 960 sq ft
                  </li>
                </ul>
              </div>
                  ...
                  <div className="col-md-12 col-sm-12 col-xs-12">
                    <div className="single_property_list">
                      ...
                      <ul className="single_property_list_mr">
                        <li>
                          <i className="fa fa-check"></i> Video
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Hairdryer
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Cot
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Dishwasher
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Parquet
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Iron
                        </li>
                      </ul>
                      <ul className="single_property_list_mr">
                        <li>
                        ...
                        <li>
                          <i className="fa fa-check"></i> Cable TV
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Grill
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Juicer
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Use of pool
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Toaster
                        </li>
                      </ul>
                      <ul>
                        <li>
              ...
              <div className="property_map">
                ...
                <div className="map-pro">
                  ...
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3504.6367998125133!2d77.32087307519986!3d28.55063468779558!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce5f133c3ff67%3A0xc866431a5e2f1091!2sSupernova%20Residency%20(Nova%20East%20%26%20Nova%20West)!5e0!3m2!1sen!2sin!4v1784114036222!5m2!1sen!2sin"
                    width="600"
                    height="450"
                    style={{border:"0"}}
                    allowFullScreen=""
                  ...
                  <div className="col-md-6 col-sm-6 col-xs-12">
                    <div className="single_property">
                      ...
                      <div className="single_property_description text-center">
                        <span>
                          <i className="fa fa-object-group"></i> 900 sq ft
                        </span>
                        <span>
                          <i className="fa fa-bed"></i> 4 Badrooms
                        </span>
                        <span>
                          <i className="fa fa-star-o"></i> 2 Baths
                        </span>
                      </div>
                      <div className="single_property_content">
                        <h4>
                          <a href="#">2045 B Street</a>
                        </h4>
                        <p>
                          Lorem Ipsum is not simply random text. It has roots in
                          a piece of classNameical.
                        </p>
                      </div>
            ...
            <div className="col-md-3 col-sm-3 col-xs-12">
              ...
              <div className="single_property_form_agent">
                <div className="single_property_form_agent_profile">
                  ...
                  />
                  <h4>
                    <i className="fa fa-phone"></i> +88 123 123 123
                  </h4>
                  <h4>
