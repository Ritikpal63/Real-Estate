...
const AdminAsideSection = () => {
  ...
  const navItems = [
    ...
    { type: "link", path: "/admin/services", label: "View Services", icon: Image },
    // { type: "link", path: "/admin/addservices", label: "Add Service", icon: PlusCircle },
    // { type: "link", path: "/admin/editservices/:id", label: "Edit Services", icon: Image },
  ];
